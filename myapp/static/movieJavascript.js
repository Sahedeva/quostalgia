          ...
          $.ajax({
            ...
            success: function(data, textStatus, jqXHR){
              ...
              for (i=0;i<directingCrewArray.length;i++) {
                ...
                resultStr += "<br><span style='color:red!important'>"+directingCrewArray[i]['job']+"</span><br><button type='button' class='castName' data-toggle='modal' data-target='#myModal' style='color:blue!important; border-radius:20px;' title='"+directingCrewArray[i]['id']+"'>"+directingCrewArray[i]['name']+"</button></div>";
              ...
              for (i=0;i<writingCrewArray.length;i++) {
                ...
                resultStr += "<br><span style='color:red!important'>"+writingCrewArray[i]['job']+"</span><br><button type='button' class='castName' data-toggle='modal' data-target='#myModal' style='color:blue!important; border-radius:20px;' title='"+writingCrewArray[i]['id']+"'>"+writingCrewArray[i]['name']+"</button></div>";
              ...
              for (i=0;i<producingCrewArray.length;i++) {
                ...
                resultStr += "<br><span style='color:red!important'>"+producingCrewArray[i]['job']+"</span><br><button type='button' class='castName' data-toggle='modal' data-target='#myModal' style='color:blue!important; border-radius:20px;' title='"+producingCrewArray[i]['id']+"'>"+producingCrewArray[i]['name']+"</button></div>";
              ...
              for (i=0;i<soundCrewArray.length;i++) {
                ...
                resultStr += "<br><span style='color:red!important'>"+soundCrewArray[i]['job']+"</span><br><button type='button' class='castName' data-toggle='modal' data-target='#myModal' style='color:blue!important; border-radius:20px;' title='"+soundCrewArray[i]['id']+"'>"+soundCrewArray[i]['name']+"</button></div>";
              ...
              for (i=0;i<data['credits']['cast'].length;i++) {
                ...
                resultStr += "<br><span style='color:red!important'>"+data['credits']['cast'][i]['character']+"</span><br><button type='button' class='castName' data-toggle='modal' data-target='#myModal' style='color:blue!important; border-radius:20px;' title='"+data['credits']['cast'][i]['id']+"'>"+data['credits']['cast'][i]['name']+"</button></div>";
